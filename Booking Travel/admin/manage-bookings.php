...
<!--heder end here-->
<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.html">Home</a><i class="fa fa-angle-right"></i>Quản lý Bookings</li>
            </ol>
...
{
echo "Hủy bởi admin vào " .$result->upddate;
} 
...
<?php } else {?>
<td><a href="manage-bookings.php?bkid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn có muốn hủy Booking')" >Hủy</a> / <a href="manage-bookings.php?bckid=<?php echo htmlentities($result->bookid);?>" onclick="return confirm('Bạn chắc chắn chứ ?')" >Xác nhận</a></td>
<?php }?>
