...
$msg="Cập nhật phản hồi thành công !";
}
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr height="50">
      <td colspan="2" class="fontkink2" style="padding-left:0px;"><div class="fontpink2"> <b>Cập nhật phản hồi</b></div></td>
...
?>
     ...
     <tr style=''>
      <td class="fontkink1" >Nội dung phản hồi:</td>
    ...
    <tr>
      <td class="fontkink1" ><b>Ngày phản hồi:</b></td>
