...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Management System</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	...
	<p style="width: 350px;">
			...
			<b>Mật Khẩu Cũ</b>  <input type="password" name="password" class="form-control" id="exampleInputPassword1" placeholder="Mật khẩu hiện tại" required="">
	</p> 
...
<b>Xác nhận mật khẩu</b>
	<input type="password" class="form-control" name="confirmpassword" id="confirmpassword" placeholder="Xác nhận mật khẩu" required="">
			...
			<p style="width: 350px;">
<button type="submit" name="submit5" class="btn-primary btn">Đổi mật khẩu</button>
			</p>
			</form>
